...
if not faceBoxes:
    ...
    for faceBox in faceBoxes:
        ...
        cv2.putText(fr_cv, f'{gender}, {age}', (faceBox[0] - 150, faceBox[1] + 10),
                    cv2.FONT_HERSHEY_SIMPLEX, 1.3, (217, 0, 0), 4, cv2.LINE_AA)

    output_path = 'output_image.jpg'  # Specify the path and filename for the output image
